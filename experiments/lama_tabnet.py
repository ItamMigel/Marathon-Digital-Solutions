...
class Model:
    ...
    Теперь используется LightAutoML с TabNet для автоматизированного обучения модели.
    """
    ...
    def train(self, data: pd.DataFrame):
        ...
        # Обучение модели LightAutoML с использованием TabNet
        logger.info("Обучение модели LightAutoML с использованием TabNet...")
        ...
        logger.info("Выполнение предсказания на тестовой выборке LightAutoML с TabNet...")
        ...
        logger.info("Сохранение модели LightAutoML с TabNet...")
    ...
    def _load_model_state(self, model_path: str, features_path: str, top_features_path: str):
        ...
        logger.info("Модель LightAutoML с TabNet успешно загружена.")

    def predict(self, data: pd.DataFrame):
        """
        Делает предсказание на основе лучшей модели LightAutoML с TabNet.
        """
        logger.info("Выполнение предсказания LightAutoML с TabNet...")
