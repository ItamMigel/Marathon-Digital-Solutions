...
def process_data(file_path: str = 'data/Телеметрия.xlsx', output_path: str = 'data/all_data.parquet'):
    ...
    df_area_1 = df[[col for col in df_columns if '2' not in col]]
    df_area_2 = df[[col for col in df_columns if '1' not in col]]
